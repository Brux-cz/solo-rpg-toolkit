...
PLATBA:
• Denní mzda (světlonoš 1ď, zbrojmyš 10ď, rytíř 25ď, tlumočník 30ď)
...
• Počet dostupných: d6 světlonošů, d4 průvodců, d3 rytířů
...
a nabídku "Vyhodnotit tah frakcí?" v bookkeepingu.`,
  },
  ukoly: {
...
NENÍ funkce appky. Appka to může podpořit (relevantní nástroje), ale neřídí.`,
  ...
  poznatky_test: {
    title: "📝 Poznatky ze suchého průchodu (4 scény, ověřeno NotebookLM)",
    text: `Suchý průchod: Ada Katzenreiserová, Mechová Lhota, kočičí pán Šedivec.
...
• DISCOVERY CHECK (2e, ověřeno NotebookLM): Zaseknutý thread → akce → Fate Q "Je něco objeveno?" (min 50/50!) → Yes=d10+progress na Thread Discovery Table. ExcNo=blokuje další pokusy ve scéně!
...
Wiki entity vytvořené: 5 NPC, 1 osada, 1 frakce, 1 thread, 1 úkol, 3 hexy`,
  },
  random_event_flow: {
...
• Pokud myši jsou překvapeny = mohou mít ZESLABENÝ útok (d4)`,
  },
  cas_cestovani: {
...
Vyjednávání = WIL záchrana (nebo vzdorovaná WIL vs WIL).`,
  },
  bestiar: {
...
const NODES = [
  ...
  { id: "poznatky_test", x: 270, y: 670, w: 440, h: 30, type: "note_alert", label: "📝 POZNATKY Z TESTU (4 scény) — 10 zjištění · 6 otázek · klikni" },
];
...
export default function SoloRPGDiagram() {
