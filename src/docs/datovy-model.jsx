...
const entities = {
  postava: {
    ...
    fields: [
      ...
      { name: "levelUpPostup", type: "note", note: "1) d20 per vlastnost (> aktuální = +1). 2) Hoď nové kostky BO (vyšší=nové BO, nižší=+1). 3) Kuráž dle tabulky." },
  ...
  pomocnik: {
    ...
    fields: [
      ...
      { name: "denniMzda", type: "number", note: "1–30ď (dle typu)" },
      { name: "vernost", type: "'běžný' | 'věrný'", note: "Věrný = WIL s výhodou" },
  ...
  mythic: {
    ...
    fields: [
      ...
      { name: "npcSeznam", type: "NpcEntry[]", note: "Max 25, váhy 1-3×" },
  ...
  scena: {
    ...
    fields: [
      ...
      { name: "sceneAdjustment", type: "string[]", note: "d10: 1=odebrat postavu, 2=přidat, 3=snížit/ODSTRANIT aktivitu, 4=zvýšit, 5=odebrat předmět, 6=přidat, 7-10=DVĚ úpravy (reroll dokud 2 různé; konflikt=ignoruj 2.; nemožný=reroll)." },
      ...
      { name: "  → pravdepodobnost", type: "enum", note: "Impossible|No way|Very unlikely|Unlikely|50/50|Likely|Very likely|Near sure|A sure thing|Has to be (10 úrovní)" },
      ...
      { name: "narativ", type: "string", note: "Příběh scény (Notion-style editor — volný text s inline bloky mechanik)" },
  ...
  boj: {
    ...
    fields: [
      ...
      { name: "prekvapeni", type: "boolean", note: "true = auto myši první + zesílený d12 útok" },
      ...
      { name: "teckyPoBoji", type: "note", note: "Za KAŽDOU použitou zbraň/zbroj: d6, hod 4-6 = škrtni tečku!" },
